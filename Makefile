...
version-import: ## check version from python import
	-$(UVRUN) python -c 'import python_packaging_tools; print(python_packaging_tools.__version__)'
...
tuna-import	: ## Analyze load time for module
	$(UVRUN) python -X importtime -c 'import python_packaging_tools' 2> tuna-loadtime.log
