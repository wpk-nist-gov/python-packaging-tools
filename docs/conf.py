...
nb_kernel_rgx_aliases = {
    "python-packaging-tools.*": "python3",
    "conda.*": "python3",
}
...
html_context = {
    ...
    "github_repo": "python-packaging-tools",
    "github_version": "main",
    "doc_path": "docs",
}
...
project = "python-packaging-tools"
copyright = "2025, William P. Krekelberg"  # noqa: A001
...
def _get_version() -> str:
    if (version := os.environ.get("SETUPTOOLS_SCM_PRETEND_VERSION")) is None:
        version = python_packaging_tools.__version__
    return version
...
html_theme_options = {
    ...
    # "canonical_url": "",
    "repository_url": f"https://github.com/{github_username}/python-packaging-tools",
...
htmlhelp_basename = "python_packaging_toolsdoc"
...
latex_documents = [
    (
        master_doc,
        "python_packaging_tools.tex",
        "python-packaging-tools Documentation",
...
def linkcode_resolve(domain: str, info: dict[str, Any]) -> str | None:
    ...
    # fmt: off
    fn = os.path.relpath(fn, start=Path(python_packaging_tools.__file__).parent)
    # fmt: on

    return f"https://github.com/{github_username}/python-packaging-tools/blob/{html_context['github_version']}/src/python_packaging_tools/{fn}{linespec}"
